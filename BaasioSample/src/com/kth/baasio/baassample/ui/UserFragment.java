...
public class UserFragment extends SherlockFragment implements OptionsItemSelectedListener,
    ...
    public static final String ENTITY_USERNAME = "username";
                        ...
                        entityDialog
                                .setEntityDialogResultListener(new EntityDialogResultListener() {
                                    ...
                                    public boolean onPositiveButtonSelected(int mode, Bundle data) {
                                        ...
                                        payload.put("badge", 1);
                                        payload.put("sound", 1);
                                        payload.put("alert", body);

                                        Map<String, Object> properties = new HashMap<String, Object>();
                                        if (TextUtils.isEmpty(tag)) {
                                            properties.put("target", "all");
                                        } else {
                                            properties.put("target", "tag");
                                            properties.put("to", tag);
                                        }

                                        properties.put("platform", platform);
                                        properties.put("payload", payload);

                                        Baasio.getInstance().sendPushAsync(properties,
                                                new ApiResponseCallback() {

                                                    @Override
                                                    public void onException(Exception e) {
                                                        Toast.makeText(getActivity(),
                                                                "sendPushAsync:" + e.getMessage(),
                                                    ...
                                                    public void onResponse(ApiResponse response) {
                                                        if (response != null) {
                                                            if (response.getError() == null
                                                                ...
                                                                Toast.makeText(
                                                                        getActivity(),
                                                                        "sendPushAsync:Sent successfully",
                                                                        Toast.LENGTH_LONG).show();
                                                            } else {
                                                                Toast.makeText(
                                                                        getActivity(),
    ...
    //
    // Kanu.getInstance().createEntityAsync(entity, new ApiResponseCallback() {
    //
    // @Override
    // public void onException(Exception e) {
    ...
    //
    // Kanu.getInstance().updateEntityAsync(entity, new ApiResponseCallback() {
    //
    // @Override
    // public void onException(Exception e) {
    ...
    private class EntityListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (entity != null) {
                setStringToView(entity, view.mName, ENTITY_USERNAME);
                        ...
                        entityDialog
                                .setEntityDialogResultListener(new EntityDialogResultListener() {
                                    ...
                                    public boolean onPositiveButtonSelected(int mode, Bundle data) {
                                        ...
                                        Map<String, Object> properties = new HashMap<String, Object>();
                                        properties.put("target", "user");
                                        properties.put("to", userUuid);
                                        properties.put("payload", payload);
